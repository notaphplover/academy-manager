...
export function UpdateOrganizationForm({
  ...
  async function onSubmit(values: z.infer<typeof schema>): Promise<void> {
    try {
      // Build update payload with only defined non-empty values
      const data: {
        logo?: string;
        name?: string;
        slug?: string;
  ...
  return (
    <Form {...form}>
      <form
        data-testid="update-organization-form"
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input
                  data-testid="update-organization-name-input"
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input
                  data-testid="update-organization-slug-input"
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input
                  data-testid="update-organization-logo-input"
